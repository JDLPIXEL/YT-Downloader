...
def open_help_website():
    webbrowser.open("mailto:jdlpixel@gmail.com")


# GUI-Setup
root = tk.Tk()
root.title("Youtube Downloader [Vollversion 2.1 German]")
...
footer_label = tk.Label(root, text="➱Vollversion 2.1", bg="#2A2A2A", fg="white", font=("Helvetica", 10))
