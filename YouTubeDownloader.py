...
def open_help_website():
    webbrowser.open("mailto:support@jdlpixel.de")


# GUI-Setup
root = tk.Tk()
root.title("Youtube Downloader [Vollversion 2.3 German]")
...
footer_label = tk.Label(root, text="➱Vollversion 2.3", bg="#2A2A2A", fg="white", font=("Helvetica", 10))
